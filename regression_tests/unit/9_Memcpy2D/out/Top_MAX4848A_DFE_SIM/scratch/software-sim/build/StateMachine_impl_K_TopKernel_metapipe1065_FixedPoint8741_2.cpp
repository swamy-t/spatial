...
maxcompilersim::state_machine::Kernel_TopKernel_metapipe1065_FixedPoint8741_2::Kernel_TopKernel_metapipe1065_FixedPoint8741_2(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_metapipe1065_FixedPoint8741_2::reset() {
	state2 = 0;
	state1 = 0;
}
...
void
maxcompilersim::state_machine::Kernel_TopKernel_metapipe1065_FixedPoint8741_2::execute(const bool sm_not_flushing) {
