...
maxcompilersim::state_machine::Kernel_TopKernel_pipe1076_sm::Kernel_TopKernel_pipe1076_sm(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_pipe1076_sm::reset() {
	state1 = 0;
	state3 = 0;
	state2 = 0;
}
...
void
maxcompilersim::state_machine::Kernel_TopKernel_pipe1076_sm::execute(const bool sm_not_flushing) {
