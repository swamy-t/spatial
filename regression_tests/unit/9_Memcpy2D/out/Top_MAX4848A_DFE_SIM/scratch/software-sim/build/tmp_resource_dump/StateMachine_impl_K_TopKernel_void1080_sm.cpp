...
maxcompilersim::state_machine::Kernel_TopKernel_void1080_sm::Kernel_TopKernel_void1080_sm(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_void1080_sm::reset() {
	state1 = 0;
	state3 = 0;
	state2 = 0;
}
...
void
maxcompilersim::state_machine::Kernel_TopKernel_void1080_sm::execute(const bool sm_not_flushing) {
