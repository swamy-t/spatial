...
// two types of boards
enum EnumBoardType {btMax2, btMax3, btMax4, btMax4N};
/* burst sizes:
    Max2       :         96 bytes;
    Max3 normal: 192 or 384 bytes;
    Max3 comp. :  48 or  96 bytes; (see extra flag)
    Max4 Coria : 192 or 384 bytes;
    Max4 Maia  : 192 or 384 bytes;
    Max4 Isca  :  96 or 192 bytes
*/
...
public:
	...
	static MemoryControllerConfigPtr getMax4NConfig(int number_words_per_burst, uint32_t eccParityEngineBitSize, uint32_t checkLevel, uint32_t max2CompatMode, uint32_t quarterMode, uint32_t cmdQSize);
