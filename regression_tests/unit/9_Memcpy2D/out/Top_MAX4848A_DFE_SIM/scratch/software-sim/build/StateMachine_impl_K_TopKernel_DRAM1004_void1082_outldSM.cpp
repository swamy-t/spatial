...
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1004_void1082_outldSM::Kernel_TopKernel_DRAM1004_void1082_outldSM(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1004_void1082_outldSM::reset() {
	state1 = 0;
}
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1004_void1082_outldSM::execute(const bool sm_not_flushing) {
