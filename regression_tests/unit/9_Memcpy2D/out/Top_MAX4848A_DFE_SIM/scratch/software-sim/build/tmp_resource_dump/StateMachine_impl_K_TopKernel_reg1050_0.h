#ifndef STATE_MACHINE_IMPL_TopKernel_reg1050_0_H
#define STATE_MACHINE_IMPL_TopKernel_reg1050_0_H
...
class Kernel_TopKernel_reg1050_0 {
public:
	Kernel_TopKernel_reg1050_0(maxcompilersim::DebugStreams *debug_output, int node_number);
	void reset();
...
#endif // !defined(STATE_MACHINE_IMPL_TopKernel_reg1050_0_H)
