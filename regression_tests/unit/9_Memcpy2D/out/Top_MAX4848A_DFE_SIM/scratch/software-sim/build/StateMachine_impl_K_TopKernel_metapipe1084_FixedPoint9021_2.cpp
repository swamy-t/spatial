...
maxcompilersim::state_machine::Kernel_TopKernel_metapipe1084_FixedPoint9021_2::Kernel_TopKernel_metapipe1084_FixedPoint9021_2(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_metapipe1084_FixedPoint9021_2::reset() {
	state2 = 0;
	state1 = 0;
}
...
void
maxcompilersim::state_machine::Kernel_TopKernel_metapipe1084_FixedPoint9021_2::execute(const bool sm_not_flushing) {
