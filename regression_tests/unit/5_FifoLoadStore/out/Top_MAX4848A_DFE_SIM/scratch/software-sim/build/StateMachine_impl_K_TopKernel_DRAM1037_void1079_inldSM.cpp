...
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1037_void1079_inldSM::Kernel_TopKernel_DRAM1037_void1079_inldSM(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1037_void1079_inldSM::reset() {
	state1 = 0;
}
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1037_void1079_inldSM::execute(const bool sm_not_flushing) {
