...
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1198_void1247_inldSM::Kernel_TopKernel_DRAM1198_void1247_inldSM(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1198_void1247_inldSM::reset() {
	state1 = 0;
}
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1198_void1247_inldSM::execute(const bool sm_not_flushing) {
