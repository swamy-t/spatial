...
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1199_void1278_outldSM::Kernel_TopKernel_DRAM1199_void1278_outldSM(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1199_void1278_outldSM::reset() {
	state1 = 0;
}
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1199_void1278_outldSM::execute(const bool sm_not_flushing) {
