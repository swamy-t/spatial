 ...
 * 
 * \param [out] outscalar_TopKernel_argout747 Output scalar parameter "TopKernel.argout747".
 * \param [out] outscalar_TopKernel_cycles Output scalar parameter "TopKernel.cycles".
 */
void Top(
	uint64_t *outscalar_TopKernel_argout747,
 ...
 */
typedef struct { 
	uint64_t *outscalar_TopKernel_argout747; /**<  [out] Output scalar parameter "TopKernel.argout747". */
