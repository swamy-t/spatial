 ...
 * 
 * \param [in] param_argin450 Interface Parameter "argin450".
 * \param [in] param_argin451 Interface Parameter "argin451".
 * \param [out] outscalar_TopKernel_argout452 Output scalar parameter "TopKernel.argout452".
 * \param [out] outscalar_TopKernel_cycles Output scalar parameter "TopKernel.cycles".
 */
void Top(
	int32_t param_argin450,
	int32_t param_argin451,
	uint64_t *outscalar_TopKernel_argout452,
 ...
 */
typedef struct { 
	int32_t param_argin450; /**<  [in] Interface Parameter "argin450". */
	int32_t param_argin451; /**<  [in] Interface Parameter "argin451". */
	uint64_t *outscalar_TopKernel_argout452; /**<  [out] Output scalar parameter "TopKernel.argout452". */
