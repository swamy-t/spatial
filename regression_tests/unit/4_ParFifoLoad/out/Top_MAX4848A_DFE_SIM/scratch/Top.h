 ...
 * 
 * \param [in] param_argin1833 Interface Parameter "argin1833".
 * \param [out] outscalar_TopKernel_argout1838 Output scalar parameter "TopKernel.argout1838".
 * \param [out] outscalar_TopKernel_cycles Output scalar parameter "TopKernel.cycles".
 */
void Top(
	int32_t param_argin1833,
	uint64_t *outscalar_TopKernel_argout1838,
 ...
 */
typedef struct { 
	int32_t param_argin1833; /**<  [in] Interface Parameter "argin1833". */
	uint64_t *outscalar_TopKernel_argout1838; /**<  [out] Output scalar parameter "TopKernel.argout1838". */
