...
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1836_void1920_inldSM::Kernel_TopKernel_DRAM1836_void1920_inldSM(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1836_void1920_inldSM::reset() {
	state1 = 0;
}
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1836_void1920_inldSM::execute(const bool sm_not_flushing) {
