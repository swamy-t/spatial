...
maxcompilersim::state_machine::Kernel_TopKernel_void1925_sm::Kernel_TopKernel_void1925_sm(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_void1925_sm::reset() {
	state2 = 0;
	state3 = 0;
	state4 = 0;
	state5 = 0;
...
void
maxcompilersim::state_machine::Kernel_TopKernel_void1925_sm::execute(const bool sm_not_flushing) {
