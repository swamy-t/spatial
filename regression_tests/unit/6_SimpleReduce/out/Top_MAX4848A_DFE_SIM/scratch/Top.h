 ...
 * 
 * \param [in] param_argin469 Interface Parameter "argin469".
 * \param [out] outscalar_TopKernel_argout470 Output scalar parameter "TopKernel.argout470".
 * \param [out] outscalar_TopKernel_cycles Output scalar parameter "TopKernel.cycles".
 */
void Top(
	int32_t param_argin469,
	uint64_t *outscalar_TopKernel_argout470,
 ...
 */
typedef struct { 
	int32_t param_argin469; /**<  [in] Interface Parameter "argin469". */
	uint64_t *outscalar_TopKernel_argout470; /**<  [out] Output scalar parameter "TopKernel.argout470". */
