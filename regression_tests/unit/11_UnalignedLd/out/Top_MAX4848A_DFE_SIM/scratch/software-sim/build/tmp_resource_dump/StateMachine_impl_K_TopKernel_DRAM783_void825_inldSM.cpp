...
maxcompilersim::state_machine::Kernel_TopKernel_DRAM783_void825_inldSM::Kernel_TopKernel_DRAM783_void825_inldSM(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM783_void825_inldSM::reset() {
	state1 = 0;
}
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM783_void825_inldSM::execute(const bool sm_not_flushing) {
