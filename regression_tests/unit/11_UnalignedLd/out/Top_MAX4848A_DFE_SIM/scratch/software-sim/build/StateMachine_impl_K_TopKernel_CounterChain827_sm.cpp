...
maxcompilersim::state_machine::Kernel_TopKernel_CounterChain827_sm::Kernel_TopKernel_CounterChain827_sm(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_CounterChain827_sm::reset() {
	state2 = 0;
	state1 = 0;
}
...
void
maxcompilersim::state_machine::Kernel_TopKernel_CounterChain827_sm::execute(const bool sm_not_flushing) {
