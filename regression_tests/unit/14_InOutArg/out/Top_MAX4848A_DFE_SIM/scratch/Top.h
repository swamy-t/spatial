 ...
 * 
 * \param [in] param_argin123 Interface Parameter "argin123".
 * \param [out] outscalar_TopKernel_argout124 Output scalar parameter "TopKernel.argout124".
 * \param [out] outscalar_TopKernel_cycles Output scalar parameter "TopKernel.cycles".
 */
void Top(
	int32_t param_argin123,
	uint64_t *outscalar_TopKernel_argout124,
 ...
 */
typedef struct { 
	int32_t param_argin123; /**<  [in] Interface Parameter "argin123". */
	uint64_t *outscalar_TopKernel_argout124; /**<  [out] Output scalar parameter "TopKernel.argout124". */
