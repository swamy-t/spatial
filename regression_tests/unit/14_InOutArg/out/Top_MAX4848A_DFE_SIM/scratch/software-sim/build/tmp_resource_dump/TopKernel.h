...
#include "StateMachine_impl_K_TopKernel_void130_sm.h"
#include "StateMachine_impl_K_TopKernel_void132_sm.h"
...
private:
  ...
  state_machine::Kernel_TopKernel_void130_sm m_sm_void130_sm;
  state_machine::Kernel_TopKernel_void132_sm m_sm_void132_sm;
  ...
  HWOffsetFix<32,0,UNSIGNED> id7out_value;

  HWOffsetFix<1,0,UNSIGNED> id5out_rst_en;
  HWOffsetFix<1,0,UNSIGNED> id5out_s0_en;
  HWOffsetFix<1,0,UNSIGNED> id5out_sm_done;

  HWOffsetFix<32,0,TWOSCOMPLEMENT> id13out_value;

  HWOffsetFix<1,0,UNSIGNED> id10out_ctr_en;
  HWOffsetFix<32,0,TWOSCOMPLEMENT> id10out_ctr_maxOut_0;
  HWOffsetFix<1,0,UNSIGNED> id10out_rst_en;
  HWOffsetFix<1,0,UNSIGNED> id10out_sm_done;
  ...
  HWOffsetFix<32,0,TWOSCOMPLEMENT> id2out_argin123;
