...
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1133_void1177_inldSM::Kernel_TopKernel_DRAM1133_void1177_inldSM(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1133_void1177_inldSM::reset() {
	state1 = 0;
}
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM1133_void1177_inldSM::execute(const bool sm_not_flushing) {
