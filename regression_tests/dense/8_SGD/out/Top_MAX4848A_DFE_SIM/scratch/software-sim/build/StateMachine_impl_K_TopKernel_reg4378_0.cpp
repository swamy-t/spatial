...
maxcompilersim::state_machine::Kernel_TopKernel_reg4378_0::Kernel_TopKernel_reg4378_0(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_reg4378_0::reset() {
	state1 = 1;
	state2 = 0;
	state4 = 0;
	state5 = 0;
...
void
maxcompilersim::state_machine::Kernel_TopKernel_reg4378_0::execute(const bool sm_not_flushing) {
