#ifndef STATE_MACHINE_IMPL_TopKernel_reg4415_1_H
#define STATE_MACHINE_IMPL_TopKernel_reg4415_1_H
...
class Kernel_TopKernel_reg4415_1 {
public:
	Kernel_TopKernel_reg4415_1(maxcompilersim::DebugStreams *debug_output, int node_number);
	void reset();
...
#endif // !defined(STATE_MACHINE_IMPL_TopKernel_reg4415_1_H)
