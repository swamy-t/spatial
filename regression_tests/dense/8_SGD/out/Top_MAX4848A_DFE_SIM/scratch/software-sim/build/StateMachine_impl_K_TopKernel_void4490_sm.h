#ifndef STATE_MACHINE_IMPL_TopKernel_void4490_sm_H
#define STATE_MACHINE_IMPL_TopKernel_void4490_sm_H
...
class Kernel_TopKernel_void4490_sm {
public:
	Kernel_TopKernel_void4490_sm(maxcompilersim::DebugStreams *debug_output, int node_number);
	void reset();
...
#endif // !defined(STATE_MACHINE_IMPL_TopKernel_void4490_sm_H)
