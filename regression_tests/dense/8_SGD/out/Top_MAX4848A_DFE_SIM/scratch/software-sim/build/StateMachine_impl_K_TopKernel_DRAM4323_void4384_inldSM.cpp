...
maxcompilersim::state_machine::Kernel_TopKernel_DRAM4323_void4384_inldSM::Kernel_TopKernel_DRAM4323_void4384_inldSM(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM4323_void4384_inldSM::reset() {
	state1 = 0;
}
...
void
maxcompilersim::state_machine::Kernel_TopKernel_DRAM4323_void4384_inldSM::execute(const bool sm_not_flushing) {
