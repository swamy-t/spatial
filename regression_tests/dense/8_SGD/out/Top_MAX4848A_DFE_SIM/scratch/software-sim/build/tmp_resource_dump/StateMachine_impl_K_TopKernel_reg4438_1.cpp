...
maxcompilersim::state_machine::Kernel_TopKernel_reg4438_1::Kernel_TopKernel_reg4438_1(maxcompilersim::DebugStreams *debug_output, int node_number) :
...
void
maxcompilersim::state_machine::Kernel_TopKernel_reg4438_1::reset() {
	state1 = 1;
	state2 = 0;
	state4 = 0;
	state5 = 0;
...
void
maxcompilersim::state_machine::Kernel_TopKernel_reg4438_1::execute(const bool sm_not_flushing) {
