...
template class HWOffsetFix<32,6,TWOSCOMPLEMENT>;
...
template class HWOffsetFix<32,5,TWOSCOMPLEMENT>;
...
template class HWOffsetFix<34,5,TWOSCOMPLEMENT>;
...
template HWOffsetFix<32,6,TWOSCOMPLEMENT> cast_bits2fixed<32,6,TWOSCOMPLEMENT>(const HWRawBits<32> &a);
template HWRawBits<48> cat<>(const HWRawBits<8> &a, const HWRawBits<40> &b);
template HWOffsetFix<32,5,TWOSCOMPLEMENT> cast_bits2fixed<32,5,TWOSCOMPLEMENT>(const HWRawBits<32> &a);
template HWOffsetFix<1,0,UNSIGNED>not_fixed<>(const HWOffsetFix<1,0,UNSIGNED> &a );
template HWOffsetFix<34,5,TWOSCOMPLEMENT>add_fixed <34,5,TWOSCOMPLEMENT,TONEAR,32,5,TWOSCOMPLEMENT,32,6,TWOSCOMPLEMENT, false>(const HWOffsetFix<32,5,TWOSCOMPLEMENT> &a, const HWOffsetFix<32,6,TWOSCOMPLEMENT> &b , EXCEPTOVERFLOW);
template HWOffsetFix<14,0,UNSIGNED> cast_fixed2fixed<14,0,UNSIGNED,TONEAR>(const HWOffsetFix<32,0,TWOSCOMPLEMENT> &a);
...
template HWOffsetFix<32,0,TWOSCOMPLEMENT> cast_fixed2fixed<32,0,TWOSCOMPLEMENT,TONEAR>(const HWOffsetFix<34,5,TWOSCOMPLEMENT> &a);
template void KernelManagerBlockSync::writeOutput< HWRawBits<32> >(const t_port_number port_number, const HWRawBits<32> &value);
template HWOffsetFix<32,0,TWOSCOMPLEMENT>add_fixed <32,0,TWOSCOMPLEMENT,TONEAR,32,0,TWOSCOMPLEMENT,32,0,TWOSCOMPLEMENT, false>(const HWOffsetFix<32,0,TWOSCOMPLEMENT> &a, const HWOffsetFix<32,0,TWOSCOMPLEMENT> &b , EXCEPTOVERFLOW);
...
template HWOffsetFix<32,0,TWOSCOMPLEMENT>sub_fixed <32,0,TWOSCOMPLEMENT,TONEAR,32,0,TWOSCOMPLEMENT,32,0,TWOSCOMPLEMENT, false>(const HWOffsetFix<32,0,TWOSCOMPLEMENT> &a, const HWOffsetFix<32,0,TWOSCOMPLEMENT> &b , EXCEPTOVERFLOW);
...
template HWOffsetFix<7,0,UNSIGNED> cast_fixed2fixed<7,0,UNSIGNED,TONEAR>(const HWOffsetFix<32,0,TWOSCOMPLEMENT> &a);
...
{return ( boost::format(_format_arg_format_string)).str();}
std::string TopKernel::format_string_TopKernel_5 (const char* _format_arg_format_string)
{return ( boost::format(_format_arg_format_string)).str();}
std::string TopKernel::format_string_TopKernel_6 (const char* _format_arg_format_string)
{return ( boost::format(_format_arg_format_string)).str();}
std::string TopKernel::format_string_TopKernel_7 (const char* _format_arg_format_string)
{return ( boost::format(_format_arg_format_string)).str();}
std::string TopKernel::format_string_TopKernel_8 (const char* _format_arg_format_string)
{return ( boost::format(_format_arg_format_string)).str();}
